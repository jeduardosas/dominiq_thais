                ...
                <div className="confirmacion-item-body">
                  ...
                  <div className="confirmacion-item-body-items">
                    <div className="confirmacion-item-body-items-novia">
                      <button>
                        <a href={`https://api.whatsapp.com/send?phone=52${data.confirmacion}&text=¡Hola!👋%0AQuiero%20confirmar%20mi%20asistencia%0Ala%20Bautizo%20de%20${data.nombre}%20`}>Confirmar</a>
                      </button>
                    </div>
                  </div>
                </div>
